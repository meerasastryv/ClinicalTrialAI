...
from platform.discovery.file_discovery import FileDiscovery
from platform.discovery.module_discovery import ModuleDiscovery
from platform.discovery.package_discovery import PackageDiscovery
